...
,if(p.patient_create_date>='#startDate#','N','E')  as 'isNewPatient'                -- If Patient Registration date = or > beginning of reporting period, set to "N". Else "E"
...
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select  1, 'Number of  Unique Patients', count(*) from TMP_patient_details t1 ; 
...
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select  4, 'Number of Males',(select count(*) from TMP_patient_details t2 where t2.gender="M") ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select  5, 'number of Females',(select count(*) from TMP_patient_details t where t.gender="F") ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select  6, 'number of Other' ,(select count(*) from TMP_patient_details t where (t.gender<>"M" and t.gender<>"F") or t.gender is null) ;
...
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 11, 'numberf New Patients',(select count(*) from TMP_patient_details t where t.isNewPatient="N") ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 12, 'number of Established Patients',(select count(*) from TMP_patient_details t where t.isNewPatient="E") ;
...
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 19, 'number of Patients with status = Active',(select count(*) from TMP_patient_details t where t.Status="A" ) ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 20, 'number of Patients with status = Dropout',(select count(*) from TMP_patient_details t where t.Status="D" ) ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 21, 'number of Patients with status = Completed',(select count(*) from TMP_patient_details t where t.Status="C" ) ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 22, '','' ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 23, 'number of Active Patients as a % of total',concat(format(100*(select count(*) from TMP_patient_details t where t.Status="A" )/@total_patient_cnt,0),"%") ;
...
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 26, 'number of Patients with school = Enrolled',(select count(*) from TMP_patient_details t where t.School_Status="E" ) ;
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 27, 'number of Patients with school = Graduated',(select count(*) from TMP_patient_details t where t.School_Status="G" ) ; 
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 28, 'number of Patients with school = Not School Age',(select count(*) from TMP_patient_details t where t.School_Status="N" ) ; 
insert into TMP_patient_summary (rowid, mylabel, mylabel_value) select 29, 'number of Patients with school = Out of School',(select count(*) from TMP_patient_details t where t.School_Status="O" ) ; 
